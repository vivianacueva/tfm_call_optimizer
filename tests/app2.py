...
# ✅ Extract only the useful answer and clean formatting
chatbot_response = response["result"].split("Useful Answer:")[-1].strip()

# ✅ Store and display only the extracted answer
